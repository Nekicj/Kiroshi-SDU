...
@Autonomous(name="21 так называемых мячей")
@Disabled
public class AutoMaybe21WithoutGate extends OpMode {
...
//                    }
            ...
            case TO_GATE:
                ...
                break;
            case TO_TAKING_3:
                if(!follower.isBusy() && actionTimer.milliseconds() > 300){
...
//                    }
    ...
    public void init(){
        ...
        if(isBlue){
            ...
            turretController.setFieldAngleTarget(222);
        }else{
