...
//                    .setTangentHeadingInterpolation()
            ...
            TAKE2_TO_SCORE = follower.pathBuilder()
                    .addPath(new BezierLine(FieldConstants.Red.GATE_OPEN,FieldConstants.Red.SCORE_POSE_GATE_FACED))
                    .setLinearHeadingInterpolation(FieldConstants.Red.GATE_OPEN.getHeading(),FieldConstants.Red.SCORE_POSE_GATE_FACED.getHeading(),0.8)
                    .setTValueConstraint(0.995)
                    .build();
            ...
            SCORE_TO_TAKE3 = follower.pathBuilder()
                    ...
                    .setLinearHeadingInterpolation(FieldConstants.Red.SCORE_POSE_GATE_FACED.getHeading(),FieldConstants.Red.Take3.START.getHeading())
                    .setTValueConstraint(0.9)
