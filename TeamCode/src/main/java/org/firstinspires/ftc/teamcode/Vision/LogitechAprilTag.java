...
//                .setTagFamily(AprilTagProcessor.TagFamily.TAG_36h11)
    ...
    public AprilTagDetection getDetectionBySpecificId(double byId){
        for(AprilTagDetection detection : detections){
            if(detection.id == byId){
                return detection;
            }
        }
        return null;
    ...
    public void showTelemetry(AprilTagDetection detectedId){
        if(detectedId == null){
            return;
        }
