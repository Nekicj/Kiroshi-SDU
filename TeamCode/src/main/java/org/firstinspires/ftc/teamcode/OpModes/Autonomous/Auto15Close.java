...
//
//@Config
//@Autonomous(name = "15+0",group = "Competition")
...
//
//            pathToTake5 = new Pose(81.25,-33.631,-0);
//            take5Final = new Pose(114,-35.4,-0.2);
//
...
//            ;
//
//            pathToTake5 = new Pose(80.64,29.07,0);
//            take5Final = new Pose(118.37,27.429,0.3);
...
//                break;
//            case 2:
//                if(!follower.isBusy() && niggtimer.milliseconds() > 1200){
